...
class DinnerFiguredOutStep extends StatefulWidget {
  ...
  const DinnerFiguredOutStep({super.key, required this.onContinue});

  @override
  State<DinnerFiguredOutStep> createState() => _DinnerFiguredOutStepState();
}

class _DinnerFiguredOutStepState extends State<DinnerFiguredOutStep> with SingleTickerProviderStateMixin {
