...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  Future<void> _removeFromCookbooks(Recipe r) async {
    ...
    try {
      ...
      final containing = cookbooks.where((cb) => cb.recipes.any((rec) => rec.id == r.id)).toList();
          ...
          children: [
            CustomScrollView(
              ...
              slivers: [
                ...
                SliverPadding(
                  padding: EdgeInsets.fromLTRB(20.w, 16.h, 20.w, 100.h + bottomPad),
                  sliver: SliverToBoxAdapter(
                    ...
                    : ValueListenableBuilder<List<Cookbook>?>(
                        ...
                        builder: (context, cookbooks, _) {
                          ...
                          if (cookbooks != null && r != null) {
                            isInCookbook = cookbooks.any((cb) => cb.recipes.any((rec) => rec.id == r.id));
                          }
...
class _RecipeDetailHeaderDelegate extends SliverPersistentHeaderDelegate {
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 32.w,
                      decoration: BoxDecoration(
                        color: progress > 0.2 ? const Color(0xFFF9FAFB).withOpacity(progress) : Colors.black12,
                        shape: BoxShape.circle,
                      ),
                      alignment: Alignment.center,
                      child: Icon(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            ...
                            size: 18.sp,
                            color: isPreview ? const Color(0xFF27AE60) : (progress > 0.5 ? const Color(0xFF1A1A1A) : Colors.white),
                          ),
                        ),
                      ),
                    ],
  ...
  Widget _buildImage(String path, double width, double height, double progress) {
    ...
    if (path.isEmpty) return Image.asset('assets/images/recipes.png', width: width, height: height, fit: fit);
    if (path.startsWith('http')) {
      return CachedNetworkImage(
        ...
        height: height,
        fit: fit,
        errorWidget: (_, __, ___) => Image.asset('assets/images/recipes.png', width: width, height: height, fit: fit),
        placeholder: (_, __) => Container(
          width: width,
          height: height,
          color: const Color(0xFFF2F1EF),
          child: Center(child: SkeletonLoader(width: 40.w, height: 40.w, borderRadius: 20.r)),
        ),
      );
    }
    return Image.asset(path, width: width, height: height, fit: fit, errorBuilder: (_, __, ___) => Image.asset('assets/images/recipes.png', width: width, height: height, fit: fit));
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 15.sp, color: const Color(0xFF111827)),
          const SizedBox(width: 2),
          Text(label, style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w600, fontSize: 13.sp, color: Color(0xFF111827))),
        ],
      ),
    );
  }
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(color: active ? const Color(0xFFC83A2D) : Colors.transparent, borderRadius: BorderRadius.circular(26)),
          child: Center(
            child: Text(label, style: TextStyle(fontFamily: 'SF Pro', fontWeight: FontWeight.w700, fontSize: 14.sp, color: active ? Colors.white : const Color(0xFF5B7C85))),
          ),
        ),
      ),
    );
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFF9FAFB), borderRadius: BorderRadius.circular(20.r), border: Border.all(color: const Color(0xFFF1F5F9))),
      child: Column(
        children: [
          Icon(icon, size: 48.sp, color: const Color(0xFFCBD5E1)),
          SizedBox(height: 16.h),
          Text(title, textAlign: TextAlign.center, style: TextStyle(fontFamily: 'SF Pro', fontSize: 15.sp, fontWeight: FontWeight.w600, color: const Color(0xFF64748B))),
          SizedBox(height: 8.h),
          Text(subtitle, textAlign: TextAlign.center, style: TextStyle(fontFamily: 'SF Pro', fontSize: 13.sp, color: const Color(0xFF94A3B8))),
        ],
      ),
    );
  }
...
class _IngredientsList extends StatelessWidget {
  ...
  const _IngredientsList({required this.ingredients, required this.currentServings, required this.originalServings});
  ...
  String _formatQuantity(RecipeIngredient ing) {
    ...
    if (scaledAmount == scaledAmount.toInt()) {
      ...
      if (formattedAmount.endsWith('.0')) formattedAmount = formattedAmount.substring(0, formattedAmount.length - 2);
    }
  ...
  @override
  Widget build(BuildContext context) {
    if (ingredients.isEmpty) return _EmptyState(icon: Icons.shopping_basket_outlined, title: "No ingredients listed", subtitle: "Check the recipe description for details.");
    return Column(
                ...
                children: [
                  if (ing.icon != null && ing.icon!.isNotEmpty) ...[
                    Container(
                      ...
                      decoration: BoxDecoration(color: const Color(0xFFFEF9C3), borderRadius: BorderRadius.circular(8.r)),
                      alignment: Alignment.center,
                      child: Text(ing.icon!, style: TextStyle(fontSize: 15.sp)),
                    ),
                  ],
                  Expanded(
                    flex: 3,
                    child: Text(ing.name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontFamily: 'SF Pro', fontSize: 13.sp, fontWeight: FontWeight.w400, color: const Color(0xFF111827))),
                  ),
                  SizedBox(width: 10.w),
                  Expanded(
                    flex: 2,
                    child: Text(_formatQuantity(ing), textAlign: TextAlign.right, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontFamily: 'SF Pro', fontSize: 13.sp, fontWeight: FontWeight.w700, color: const Color(0xFF6B7280))),
                  ),
                ],
              ),
            ),
            if (i < ingredients.length - 1) const Divider(height: 0, color: Color(0xFFF0F0F0)),
          ],
        );
      }),
    );
...
class _EquipmentList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (equipment.isEmpty) return _EmptyState(icon: Icons.soup_kitchen_outlined, title: "No specific equipment listed", subtitle: "Standard kitchen tools should be enough.");
    return Column(
      children: List.generate(equipment.length, (i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16.r), border: Border.all(color: const Color(0xFFF1F5F9)), boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 10, offset: const Offset(0, 4))]),
          child: Row(
            children: [
              Expanded(child: Text(item, style: TextStyle(fontFamily: 'SF Pro', fontSize: 13.sp, fontWeight: FontWeight.w600, color: const Color(0xFF111827)))),
              Icon(Icons.check_circle_outline_rounded, size: 18.sp, color: const Color(0xFFCBD5E1)),
            ],
          ),
        );
      }),
...
class _StepsList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (steps.isEmpty) return _EmptyState(icon: Icons.format_list_numbered_rtl, title: "No steps listed", subtitle: "Follow your intuition or check the source.");
    return Column(
      children: [
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: const Color(0xFFC83A2D).withOpacity(0.1), shape: BoxShape.circle),
                  alignment: Alignment.center,
                  child: Text('${i + 1}', style: TextStyle(fontFamily: 'SF Pro', fontWeight: FontWeight.w800, fontSize: 13.sp, color: const Color(0xFFC83A2D))),
                ),
                SizedBox(width: 10.w),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Builder(builder: (context) {
                        ...
                        return Text(content, style: TextStyle(fontFamily: 'SF Pro', fontSize: 14.sp, height: 1.6, color: const Color(0xFF111827), fontWeight: FontWeight.w500));
                      }),
                    ],
                  ),
                ),
        ...
        if (equipment.isNotEmpty) ...[
          ...
          Text('Required Equipment', style: TextStyle(fontFamily: 'SF Pro', fontSize: 16.sp, fontWeight: FontWeight.w700, color: const Color(0xFF1E293B))),
        ...
        if (tips != null && tips!.isNotEmpty) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFF9FAFB), borderRadius: BorderRadius.circular(16.r), border: Border.all(color: const Color(0xFFF3F4F6))),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 8.w),
                    Text('Notes / Tips', style: TextStyle(fontFamily: 'SF Pro', fontWeight: FontWeight.w700, fontSize: 14.sp, color: const Color(0xFF1F2937))),
                  ],
                ),
                SizedBox(height: 8.h),
                Text(tips!, style: TextStyle(fontFamily: 'SF Pro', fontSize: 14.sp, height: 1.5, color: const Color(0xFF4B5563))),
              ],
            ),
          ),
        ],
