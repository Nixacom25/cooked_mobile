...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  DetailTab _activeTab = DetailTab.ingredients;
  ...
  void _initRecipeData(Recipe r) {
    _recipe = r;
    _currentServings = r.servings != null && r.servings! > 0 ? r.servings! : 2;
    _originalServings = r.servings != null && r.servings! > 0 ? r.servings! : 2;
  ...
  Widget build(BuildContext context) {
    ...
    final String time = r != null
        ...
        : (args['time'] as String? ?? '20 min');
    final String kcal = r != null
        ? '${r.kcal} kcal'
        : (args['kcal'] as String? ?? '417 kcal');
                  ...
                  if (_isLoading && r == null)
                    ...
                    CustomScrollView(
                      ...
                      slivers: [
                            ...
                            child: Wrap(
                              ...
                              children: [
                                _TagPill(
                                  ...
                                  label: time.isNotEmpty ? time : '20 min',
                                ),
                                _TagPill(
                                  icon: Icons.local_fire_department_rounded,
                                  label: kcal.isNotEmpty ? kcal : '417 kcal',
                                ),
                                _TagPill(
                        ...
                        // Steps / Ingredients Tab Switcher
                        SliverPersistentHeader(
                          pinned: true,
                        ...
                        // Content List (Steps or Ingredients)
                        SliverPadding(
                                ...
                                children: [
                                  if (_activeTab == DetailTab.ingredients)
                                    _IngredientsList(
                                      ...
                                      originalServings: _originalServings,
                                      showSavings: (r != null &&
                                          (r.origin?.toUpperCase() == 'SCAN' ||
                                              r.origin?.toUpperCase() == 'SUGGESTED' ||
                  ...
                  children: [
                    if (ing.icon != null && ing.icon!.isNotEmpty) ...[
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Icon(Icons.fastfood_rounded, size: 16.sp, color: const Color(0xFFD97706)),
                      ),
                    ],
                    Expanded(
                      flex: 3,
